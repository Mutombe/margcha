...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <div className={`fixed inset-0 bg-black/90 z-40 md:hidden transition-opacity duration-300 ${showNav ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        <div className="flex flex-col items-center justify-center h-full">
          ...
          <nav className="flex flex-col items-center space-y-6">
            <a href="#" onClick={() => {setActiveTab('contact'); setShowNav(false);}} className={`text-xl font-medium ${activeTab === 'contact' ? 'text-maroon-400' : 'text-white'}`}>Contact</a>
            <a href="#" onClick={() => {setActiveTab('services'); setShowNav(false);}} className={`text-xl font-medium ${activeTab === 'services' ? 'text-maroon-400' : 'text-white'}`}>Services</a>
            <a href="#" onClick={() => {setActiveTab('faq'); setShowNav(false);}} className={`text-xl font-medium ${activeTab === 'faq' ? 'text-maroon-400' : 'text-white'}`}>FAQ</a>
            <a href="#" onClick={() => {setActiveTab('testimonials'); setShowNav(false);}} className={`text-xl font-medium ${activeTab === 'testimonials' ? 'text-maroon-400' : 'text-white'}`}>Testimonials</a>
          </nav>
          
          <div className="absolute bottom-12 flex space-x-4">
            <a href="tel:+2637835746777" className="text-white hover:text-maroon-400">
              <Phone size={24} />
            </a>
            <a href="mailto:margcha.shopfitting@gmail.com" className="text-white hover:text-maroon-400">
              <Mail size={24} />
            </a>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white pt-20">
          <div className="animate-fadeIn">
            ...
            <p className="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed">
              Quality craftsmanship and exceptional service for all your shopfitting needs.
            </p>
            ...
            {contactInfo.map((info, index) => (
              <div key={index} className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-1">{info.details[0]}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-12 md:py-16 bg-white relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <span className="inline-block px-3 py-1 bg-maroon-100 text-maroon-800 rounded-full text-sm font-medium mb-3">Get In Touch</span>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Ready to Work Together?</h2>
            ...
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">{info.title}</h3>
    ...
    <MapComponent />
            ...
            {/* Contact Form */}
            <div id="contact-form" className="bg-white rounded-2xl shadow-xl overflow-hidden">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
                    ...
                    <div>
                      <button
                        ...
                        className={`inline-flex justify-center items-center w-full px-6 py-3 border border-transparent rounded-full shadow-sm text-base font-medium text-white bg-maroon-600 hover:bg-maroon-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-maroon-500 transition-all duration-300 ${formStatus.isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
                      >
